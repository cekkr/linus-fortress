...
<div style="display:table; width:1000px;">
	<div style="display:table-cell;text-align:center;vertical-align:middle"> 
		<?php 
		if($res==1)echo '<h2 style="background-color:green">Connected successfully</h2>';
		if($res==-1)echo '<h2 style="background-color:orange">Computer not connected</h2>';
		if($res==-2)echo '<h2 style="background-color:red">Authentication failed</h2>'; ?> <br>
